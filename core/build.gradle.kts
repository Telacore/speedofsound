...
dependencies {
    ...
    api(files("libs/sherpa-onnx-v1.13.2.jar"))
    api(files("libs/sherpa-onnx-native-lib-linux-x64-v1.13.2.jar"))
    api(files("libs/sherpa-onnx-native-lib-linux-aarch64-v1.13.2.jar"))
